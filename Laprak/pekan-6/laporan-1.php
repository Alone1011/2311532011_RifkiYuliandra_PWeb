...
<html lang="id">
  <head>
    ...
    <title>Laporan CRUD PHP OOP - Rifki Yuliandra</title>
    <!-- Bootstrap CSS -->
    <link
      ...
      <div class="row g-5 g-lg-5">
        ...
        <div class="col-12 col-lg-8">
          <article class="blog-content">
            <!-- Teori OOP -->
            <section class="mb-5">
              <h3 class="section-title">Konsep OOP dalam Implementasi CRUD</h3>
              <div class="row g-4">
                <div class="col-md-6">
                  <div class="theory-card">
                    ...
                    <h5>Class & Object</h5>
                    <p>
                      Class sebagai blueprint untuk membuat object Mahasiswa dan
                      Database
                    </p>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="theory-card">
                    ...
                    <h5>Encapsulation</h5>
                    <p>
                      Menyembunyikan detail implementasi database dengan access
                      modifier private
                    </p>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="theory-card">
                    ...
                    <h5>Inheritance</h5>
                    <p>
                      Class Mahasiswa mewarisi koneksi database dari class
                      Database
                    </p>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="theory-card">
                    ...
                    <h5>Polymorphism</h5>
                    <p>
                      Method read() dapat menerima parameter berbeda untuk
                      fungsi berbeda
                    </p>
                  </div>
                </div>
            ...
            <section class="mb-5">
              ...
              <div class="step-card">
                ...
                <div class="step-content">
                  <ol>
                    <li>
                      Buat folder <code>crud</code> dalam <code>htdocs</code>
                    </li>
                    <li>
...
└── index.php</code></pre>
              ...
              <div class="step-card">
                <div class="step-header">
                  ...
                  <h5>Membuat Database dan Tabel</h5>
                </div>
                <div class="step-content">
                  <pre><code>CREATE DATABASE pemrograman_web;
USE pemrograman_web;
  ...
  jurusan VARCHAR(128) NOT NULL
              ...
              <div class="step-card">
                <div class="step-header">
                  ...
                  <h5>Koneksi Database</h5>
                </div>
                <div class="step-content">
                  <p>File <code>config/Database.php</code>:</p>
                  <pre><code>&lt;?php
class Database {
...
?&gt;</code></pre>
              ...
              <div class="step-card">
                ...
                <div class="step-content">
                  ...
                  <pre><code>&lt;?php
define('BASE_URL', 'http://localhost/crud/');</code></pre>
                </div>
              </div>
...
?&gt;</code></pre>
              ...
              <div class="step-card">
                <div class="step-header">
                  ...
                  <h5>Class Mahasiswa</h5>
                </div>
                <div class="step-content">
                  <p>File <code>model/Mahasiswa.php</code>:</p>
                  <pre><code>&lt;?php
session_start();
class Mahasiswa {
    private $conn;
    ...
    public function __construct($db) {
        $this->conn = $db;
                ...
                <div class="step-card">
                  <div class="step-header">
                    <h5>Implementasi CRUD dalam Class Mahasiswa</h5>
                  </div>
                  <div class="step-content">
        ...
        header("Location: index.php?msg=0");
              ...
              <div class="step-card">
                <div class="step-header">
                  ...
                  <h5>Fungsi Mahasiswa</h5>
                </div>
                <div class="step-content">
                  <p>File <code>function/Mahasiswa.php</code>:</p>
                  <pre><code>&lt;?php
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button
                        ...
                        type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#indexCollapse"
                      >
                        Index.html
                      </button>
                    </h2>
                    <div id="indexCollapse" class="accordion-collapse collapse">
                      <div class="accordion-body">
                        <p>File <code>index.php</code> (extract):</p>
                        <pre><code>&lt;?php
...
&lt;/html&gt;</code></pre>
                  ...
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        <p>File <code>create.php</code> (extract):</p>
...
&lt;/html&gt;</code></pre>
                  ...
                  <div class="accordion-item">
                    ...
                    <div id="editCollapse" class="accordion-collapse collapse">
                      <div class="accordion-body">
                        <p>File <code>edit.php</code> (extract):</p>
                        <pre><code>&lt;?php 
    include_once './config/Database.php'; 
    include_once './model/Mahasiswa.php'; 
